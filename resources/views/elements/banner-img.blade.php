<div class="container ">
   ...
   <!-- #banner-text start -->
      <div id="banner-text" class="col-md-7 text-c text-left ">
         ...
         <p class="banner-text wow fadeInUp main-h3" data-wow-delay="0.8s">Compra un coche electrico y gestiona sus datos para<br> mejorar su rendimiento y capacidades. </p>
