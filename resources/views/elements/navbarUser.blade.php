 <div class="header-logo">
   <a class="navbar-brand logo-biss" href="/"> <img src="{{asset('assets/images/logo.png')}}">  </a>
</div>
<!-- end header-logo -->
   ...
   <div class="header-nav__content">
      ...
      <ul class="header-nav__list">
         ...
         <li>
           ...
           <form id="logout-form-desplegable" action="{{ route('logout') }}" method="POST" style="display: none;">
              @csrf
           </form>
         </li>
